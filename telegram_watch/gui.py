...
const _i18n = {
  en: {
    ...
    messageTemplateHelp: "Choose the layout for each realtime push message. ID display, time format, and language preferences still apply on top of the chosen template.",
    template: "Template",
  ...
  zh: {
    ...
    messageTemplateHelp: "选择实时推送单条消息的版面样式。ID 显示、时间格式、语言设置会叠加在所选模板之上。",
    template: "模板",
    templateNormal: "标准",
    templateMinimal: "极简",
